...
public:
  ...
  edgev& operator=(const edgev& eg) {
	...
	edgev(long id1, long esid1,long evp1, short lbl1, double ecost1, double scost1, double tcost1,double slen1, 
		long frid1, long toid1, long orig1, double palong1, short tway1,short dirn1,short toStop1, int lts1) ; // constructor
 
	edgev() : id(0), esid(0), evp(0),  lbl(0),  ecost(inf),  scost(inf),tcost(inf),
		  slen(0),palong(0),frid(0), toid(0), orig(-1), tway(-1), dirn(0),toStop(0),
		  efc(""),stopoff(-1),stopon(-1),lts(999),orfc(""),ornm(""),enote("")
		  { 
		//cout << "ev[" << id << "]" << " Create " << " create " << endl; 
	}; 
    void ev( long eid1=0,long esid1=0,long evp1=0, short lbl1=0, double ecost1=inf, double scost1=inf,
		double tcost1=inf,double slen1=0, long frid1=0, long toid1=0, long orig1=-1, double palong1=0.0, short tway1=-1, 
		short dirn1=0,short toStop1=0, int lts1=999)
	{
	id = eid1; // edge id
...
//	static long create, assign, copycons, destroy, sid;
        	...
        	string efc; // edge street pointer
        	string orfc; //Origin stop pointer
...
edgev::edgev( long id1, long esid1=0,long evp1=0, short lbl1=0, double ecost1=0,double scost1=0,
			 ...
			 short tway1=-1,short dirn1=0,short toStop1=0,int lts1=999) : id(id1), esid(esid1),evp(evp1), lbl(lbl1), ecost(ecost1), 
			 scost(scost1), tcost(tcost1),slen(slen1),frid(frid1),toid(toid1),orig(orig1), palong(palong),
			 tway(tway1),dirn(dirn1),toStop(toStop1),lts(lts1)
{
  // cout << "ev[" << id << "]" << endl;
}
...
//WkTmOns,WkTmOffs,External_,WalkCost,RideCost,OperCost,TCost,External,Eliminated,StopLoc,XCoord,YCOORD
	...
	tstop(long id1, string StopLbl1, long Stopidp1,long Stopids1, int StOrdr1,  string StopName1, double CumDist1, double CRdTm1, 
		...
		double TCost1=0,short blnElm1=0,long Edgeid1=-1, double xc1=0, double yc1=0 , double zc1=0 );
	...
	tstop() : id(0), tripid(-1), StopLbl(""), Stopidp(-1),Stopids(-1), StOrdr(-1),  StopName(""), 
		...
		RideCost(0),OperCost(0),TCost(0),Edgeid(-1),palong(0),lbl(0),xc(0),yc(0),zc(0) {};
...
public:
  ...
  friend ostream&  operator<<(ostream& os, const EdgeAccum& EgAc) {
	...
	short get_toStop () {return toStop;}
...
template <typename m, typename o, typename  infile >
m& readBinEdgeObjectData(m& m1, o& o1, infile& pIf)
{
long id;
//edgev ev;
  do
